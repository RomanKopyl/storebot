...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            'photo' => 'https://www.google.com.ua/search?q=iphone&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjA0pfrvu_fAhXCbFAKHaF1B_4Q_AUIDigB&biw=1280&bih=882#imgrc=uKKCvwvgdGREmM:',
        ...
        DB::table('products')->insert([
            'name' => 'iphone2',
            'photo' => 'https://www.google.com.ua/search?q=iphone&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjA0pfrvu_fAhXCbFAKHaF1B_4Q_AUIDigB&biw=1280&bih=882#imgrc=aCl6IhWPpwqhjM:',
