...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            'name' => 'ASUS X540UB (X540UB-DM147)',
            'photo' => 'https://brain.com.ua/static/images/prod_img/2/3/U0308023_big.jpg',
            'description' => 'Основні характеристики серія ASUS X Тип ноутбука мультимедійний центр дисплей Діагональ дисплея 15.6 " процесор процесор Intel Core i3 6006U (2.0 ГГц)',
            'category_id' => '3',
            'price' => '13666',
        ]);
        DB::table('products')->insert([
